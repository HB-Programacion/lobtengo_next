    ...
    return(
        <AppLayout>
            <div className="nosotros-home">
                ...
                <div className="nosotros-home--title">La única manera de llevarse un depa por S/60 soles</div>
                <div className="nosotros-home--img">
                    <img src="./icons/nosotros/nosotros-home.svg"/>
                </div>
                <div className="nosotros-home--descripcion1">Nuestra mecánica de sorteo limitado te ofrece <span>altísimas posibilidades de ganar en comparación a cualquier lotería del mercado.</span>
                </div>
                <div className="nosotros-home--descripcion2">
                Ideal para personas que desean acceder a una propiedad sin necesidad de iniciales, préstamos y demás trámites.
                </div>
            </div>
                <CardNosotros/>
                <SectionPreguntas/>
